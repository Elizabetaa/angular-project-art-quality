...
export function passwordDontMatch(getTargetControl: () => AbstractControl | null, killSubscriptions: Observable<any>) {
    ...
    return function (control: AbstractControl) {
      ...
      return targetControl?.value === control?.value ? null : { passwordDontMatch: true }
    };
  }